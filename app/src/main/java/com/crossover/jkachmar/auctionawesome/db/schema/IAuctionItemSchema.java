...
public interface IAuctionItemSchema {
    ...
    String[] AUCTION_ITEM_COLUMNS = new String[]{COLUMN_ID,
            COLUMN_ID, COLUMN_ITEM_NAME, COLUMN_ITEM_DESCRIPTION, COLUMN_DATE_CREATED, COLUMN_CREATED_BY, COLUMN_EXPIRES_IN, COLUMN_STARTING_BID, COLUMN_CURRENT_BID, COLUMN_CURRENT_BIDDER};
}